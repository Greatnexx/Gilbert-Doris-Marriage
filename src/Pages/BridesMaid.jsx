    ...
    <>
     ...
     <section className="pt-24 pb-16 bg-gray-100">
         <div className="text-center mb-12 px-4">
           <h1 className="text-3xl md:text-4xl font-bold">BRIDESMAID</h1>
           <div className="flex justify-center items-center gap-2 my-4">
             <span className="w-16 h-[2px] bg-gray-300"></span>
             <i className="fa fa-heart text-red-500" />
             <i className="fa fa-heart text-gray-400" />
             <span className="w-16 h-[2px] bg-gray-300"></span>
           </div>
           <p className="max-w-2xl mx-auto text-gray-600">
             Our beautiful bridesmaids are here to support us on our special day.
           </p>
         </div>
       ...
       <Footer image="url('assets/images/doris5.jpg')"
               position="center 30%"
             />
